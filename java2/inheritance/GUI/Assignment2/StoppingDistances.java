...
class SpeedFrame extends Frame implements ActionListener {
 ...
 public void actionPerformed(ActionEvent e) {
  if (e.getSource() == clear) {
   ...
   checkValidVals();
   checkNumeric(startSpeed.getText(), endSpeed.getText(), incrementSpeed.getText());

   if (checkNumericValue(startSpeed.getText(), endSpeed.getText()) == true &&
    checkNumeric(startSpeed.getText(), endSpeed.getText(), incrementSpeed.getText()) == true) {
    {
     area.append(" *********************************\n");
     ...
     for (int currentSpeed = start; currentSpeed <= end; currentSpeed += increment) {
      ...
      String print = String.format(" *%10d %10d          *\n", currentSpeed, stoppingDistance);
      area.append(print);
     }
 ...
 public boolean checkNumeric(String input1, String input2, String input3) {
  try {
